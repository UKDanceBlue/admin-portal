...
const SpiritTeamList = () => {
  ...
  return (
    <>
      <h1>Spirit Teams</h1>
      <p>
        You can hover over a column&apos;s header and click the ... button
        to show sorting and filtering options. Be warned that sorting by a
        field will HIDE any teams that have no value for that field
